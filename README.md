...
| **기능** | **상세 내용** | **설명** |
| --- | --- | --- |
| 고용주 근로계약서 작성 | 고용주가 근로계약서 작성 버튼을 눌렀을 때 동작되는 기능입니다. | request body의 내용이 근로계약서에 작성될 뿐 아니라 고용주 서명이 함께 작성되어 gcs에 저장됩니다.
이미 만들어진 근로계약서에 대해서는 동작하지 않습니다.  |
...
| 지원서 등록 | 근로자의 지원서 저장 및 지원 상태 저장.
 | 근로자가 지원서를 작성하여 특정 구인글에 지원서를 등록합니다. |
